...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.embed_to_hidden_weight = nn.Parameter(torch.empty(
        ...
        self.hidden_to_logits_weight = nn.Parameter(torch.empty(
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings, 0, w.flatten()).view(
            w.size(0), self.n_features * self.embed_size
        )
    ...
    def forward(self, w):
        ...
        hidden = self.dropout(F.relu(
            embed @ self.embed_to_hidden_weight + self.embed_to_hidden_bias
        ))
